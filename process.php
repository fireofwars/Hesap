...
<div class="container">
      ...
      <form method="post" action="process.php">
        <div class="form-group">
          <label for="selectOption">Doviz hesabı yapma</label>
        ...
        <input type="text" name="kutu"placeholder="tutar girin"></input>
...
$hesap=$_POST["kutu"];
  ...
  if (isset($_POST['optionValue'])) {
    $selectedOption = $_POST['optionValue'];
    if ($selectedOption == "1")
     {
    echo $usdAlis*$hesap;
